...
@Component({
  selector: 'app-mpubmodule-detail-sel',
  templateUrl: './mpubmodule-detail-sel.component.html',
  styleUrls: ['./mpubmodule-detail.component.css']
})
export class MpubmoduleDetailSelComponent extends MpubmoduleDetailComponent 
        implements OnInit {
    @Input() inputData;
    @Output() outputData;
