...
import { PipelineListCustComponent } from '../../../pipeline-cust/base/pipeline/pipeline-list.cust.component';
...
export class PipelineListComponent extends PipelineListCustComponent implements OnInit {
