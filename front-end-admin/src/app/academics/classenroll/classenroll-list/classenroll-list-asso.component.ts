...
} from './classenroll-list-sub.component';
import {
  ClassenrollService
...
export class ClassenrollListAssoComponent extends ClassenrollListSubComponent implements OnInit {
  ...
  constructor(public classenrollService: ClassenrollService, public injector: Injector, public router: Router, public route: ActivatedRoute, public location: Location) {
