...
~/dev/mean-rest/src/mean-rest-angular-cli/bin/mra.js -m academics -o src/app ../../lka/models/academics/index.js
~/dev/mean-rest/src/mean-rest-angular-cli/bin/mra.js -m pipeline -o src/app ../../lka/models/pipeline/index.js
