...
export const ManageRoutes: Routes = [
  { path: 'manage', 
    ...
    children: [ 
      ...
      {path: "student",  children: studentRoutingPath, 
         data: {"mraLevel": 1, "item": "student"}},
      {path: "teacher",  children: teacherRoutingPath, 
         data: {"mraLevel": 1, "item": "teacher"}},
      {path: "course",  children: courseRoutingPath, 
         data: {"mraLevel": 1, "item": "course"}},
    ]
  }
];
/*>>> Please check this recent updates and merge with existing ones***
**Date: Sat Nov 03 2018 22:34:12 GMT-0700 (PDT)
